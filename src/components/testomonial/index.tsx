...
const testimonials = [
  {
    ...
    role: 'Co-Founder',
    image: '/images/67e311ff0c2b4cfbe4669670_avatar-1.avif',
    text: 'Gynger simplifies our procurement process and helps us be more thoughtful about our tech stack.',
  },
  {
    name: 'Jane Smith',
    role: 'VP of Finance',
  ...
  },
  {
    ...
    role: 'CTO',
    image: '/images/67e311ff0c2b4cfbe4669670_avatar-1.avif',
    text: 'Gynger is a game-changer in how we finance our software expenses.',
  },
];
      ...
      >
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-md md:text-lg text-gray-500">{t.role}</p>
          </div>
        </div>
